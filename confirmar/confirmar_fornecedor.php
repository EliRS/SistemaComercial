...
$exibir = array("Nome: ", "CNPJ: " , "Telefone: ", "Email: ", "CEP: ", "Rua: ", "Bairro: ", "Cidade: ", "UF: ");
...
$res = array($_POST['nome'], 
	...
	if(isset($res[0]) != ""){
		...
		$caminho = "fornecedor.txt"; //caminho onde sera criado o arquivo
		$conteudo = "$res[0], $res[1], $res[2], $res[3], $res[4], $res[5], $res[6], $res[7], $res[8]
";
