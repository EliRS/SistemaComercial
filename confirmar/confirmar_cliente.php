...
$exibir = array("Nome: ", "Idade: " , "Sexo: ", "CPF: ", "RG: ", "Telefone: ","E-mail: ", "CEP: ", "Rua: ", "Bairro: ", "Cidade: ", "UF: ");
...
$res = array($_POST['nome'], 
	...
	if(isset($res[0]) != ""){
		...
		$caminho = "cliente.txt"; //caminho onde sera criado o arquivo
		$conteudo = "$res[0], $res[1], $res[2], $res[3], $res[4], $res[5], $res[6], $res[7], $res[8], $res[9], $res[10], $res[11]
";
