...
<?php
	...
	//por <br>
	$caminho =file('..\confirmar\produto.txt');

	foreach ($caminho as $information) {
		$information = trim($information);
		$informationFinal = explode(', ', $information);
		echo $printDados = "<h3> Nome: " . $informationFinal[0] . "<br>Data de Validade: " . $informationFinal[1]."<br>Preço: " . $informationFinal[2] . "<br>Quantidade: " . $informationFinal[3]."<br>"."</h3>"."<br><br>";
	}
