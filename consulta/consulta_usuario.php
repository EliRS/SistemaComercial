...
<?php
	...
	//por <br>
	$caminho =file('..\confirmar\usuario.txt');


	foreach ($caminho as $information) {
		$information = trim($information);
		$informationFinal = explode(', ', $information);
		echo $printDados = "<h3> Nome: " . $informationFinal[0] . "<br>Idade: " . $informationFinal[1]."<br>Sexo: " . $informationFinal[2] . "<br>Telefone: " . $informationFinal[3]."<br>E-mail: ". $informationFinal[4]."<br>Username: ". $informationFinal[5]."<br><br>"."</h3>"."<br><br>";
}
