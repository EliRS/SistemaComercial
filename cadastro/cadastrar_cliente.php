...
<center>
  ...
  <div class="container">
    <br>
	 <form action="../confirmar/confirmar_cliente.php" method="POST" enctype="multipart/form-data">	
      ...
      <br>
			...
			<br>
      <br>
			CPF: <input type="text" maxlength="14" name="cpf">
			<br>
      <br>
			RG: <input type="text" name="rg" style="margin-left: 2.1%;">
			<br>
      <br>
			Telefone: <input type="tel" placeholder="(99)9999-9999" pattern="\(\d{2}\)\d{4}-\d{4}" maxlength="13" name="telefone">
			<br>
      <br>
      ...
      <div id="trocar">
        	...
        	<label>Estado:
        	<input name="uf" type="text" id="uf" size="2" /></label><br /><br><br>
